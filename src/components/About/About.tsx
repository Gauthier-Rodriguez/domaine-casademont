    ...
    <>
      ...
      <main className='min-h-screen w-full px-4 sm:px-6 lg:px-8 mt-20 sm:mt-24'>
        <section className='max-w-4xl mx-auto'>
          ...
          <p className='mt-4 p-5 sm:mt-5 text-base sm:text-lg text-justify leading-relaxed'>
